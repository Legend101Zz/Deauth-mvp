    ...
    <section className="min-h-screen flex items-center mt-[5em] md:mt-0 bg-transparent">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative lg:-mt-[6em] -mt-[6em]">
            <motion.div
            ...
            >
              ...
              <motion.div
                ...
                animate={{ scale: 1, opacity: 1 }}
                transition={{ duration: 1 }}
                className="absolute z-0 top-[2em] lg:mr-0 -mr-3 lg:top-[2em]"
              >
                <Image
                  src="/base.png"
                  alt="Base Image"
              ...
              <motion.div
                initial={{ y: -20 }} // Start position
                animate={{
                  y: [0, -10, 0], // Keyframes for bounce
                }}
              >
                <Image
                  src="/hood.png"
                  ...
                  style={{
                    filter: "brightness(1.7) contrast(0.9) saturate(1.2)",
                    transition: "filter 0.3s ease-in-out",
                  }}
                />
              </motion.div>

              {/* <Image src="/base.png" width={400} height={400} alt="base Image" className="relative"/> */}
